...
#include <memory>
#include "../../demo1/customchartview.h"
...
QT_MOC_LITERAL(3, 28, 5) // "point"
    ...
    "customChartView\0mouseMoved\0\0point"
};
...
void customChartView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (customChartView::*)(QPointF );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&customChartView::mouseMoved)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void customChartView::mouseMoved(QPointF _t1)
{
